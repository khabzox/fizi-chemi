        ...
        <SignUp.Step name="start" className="w-full p-4 rounded-lg">
          <div className="text-start pb-3 font-bold">
            ...
            Vous avez déjà un compte ? {" "}
              <Link href={"/auth/sign-in"} className="underline font-medium text-secondary">Se Connecter</Link>
            </p>
          </div>
          ...
          <Clerk.Field name="password">
            ...
            <div className="relative">
              <Clerk.Input
                ...
                className="w-full my-1 p-2 border-2 border-primary rounded-lg bg-white placeholder:text-primary placeholder:opacity-70 focus:border-primary focus:outline-none pr-10" 
          ...
          <p className="py-3 px-5 text-sm text-center">En cliquant sur {"S'inscrire"}, vous acceptez {" "}
